...
public class AdminStatusController {
    ...
    public AdminStatusController(ConsultantRepository consultantRepository, BookingRepository bookingRepository) {
...
public ResponseEntity<?> getSystemStatus() {
    try {
        ...
        for (Booking currentBooking : allBookings) {
            ...
            if ("Requested".equals(currentStateName)) requestedBookingCount++;
            else if ("Pending Payment".equals(currentStateName)) pendingPaymentCount++;
            else if ("Paid".equals(currentStateName))  paidBookingCount++;
            else if ("Completed".equals(currentStateName)) completedBookingCount++;
        }

        SystemStatusResponse response = new SystemStatusResponse(pendingConsultantCount, requestedBookingCount,
                pendingPaymentCount, paidBookingCount, completedBookingCount, null);
